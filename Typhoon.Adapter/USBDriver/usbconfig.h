 ...
 */
#define USB_CFG_MAX_BUS_POWER           100//20
 ...
 */
#define USB_CFG_VENDOR_NAME     'K', 'o', 'n', 's', 't', 'a', 'n', 't', 'i', 'n', ' ', 'K', 'o', 'l', 'e', 's', 'n', 'i', 'k'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'y', 'p', 'h', 'o', 'o', 'n', ' ', 'A', 'd', 'a', 'p', 't', 'e', 'r'
